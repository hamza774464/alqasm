...
window.whatsappMessage = function (phoneNumber) {
  const message =
    "مرحباً، أريد الاستفسار عن المجالس الجاهزة من مظلات وسواتر القاسم الحديثة - أفضل مجالس خارجية بالرياض";
  window.open(
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (floatingPhone) {
    floatingPhone.addEventListener("click", function (e) {
      ...
      if (
        confirm(
          "هل تريد الاتصال بالرقم 532228615؟ مظلات وسواتر القاسم الحديثة - أفضل مجالس خارجية بالرياض"
        )
      ) {
